    ...
    return (
        <footer className="border-t border-accent flex flex-col items-center">
            <ul className="flex justify-center items-center gap-3.5 py-5">
                <li className="text-sm pr-6 border-r border-primary/50">
                    <Link href="https://github.com/m4c1elz/mpost">
                        <svg
                            role="img"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                            className="fill-primary/50 hover:fill-primary transition"
                            height={40}
                        >
                            <title>GitHub</title>
