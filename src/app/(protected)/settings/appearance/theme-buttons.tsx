    ...
    return (
        <div className="flex gap-4 items-center">
            <div className="flex flex-col items-center gap-2">
                <button
                    className="aspect-square bg-[hsl(0,0%,100%)] size-36 md:size-40 rounded border border-foreground flex flex-col justify-center items-start gap-4 px-4 py-2"
            ...
            <div className="flex flex-col items-center gap-2">
                <button
                    className="aspect-square bg-[hsl(240,10%,3.9%)] size-36 md:size-40 rounded border border-foreground flex flex-col justify-center items-start gap-4 px-4 py-2"
